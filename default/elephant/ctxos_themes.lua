--
-- Dynamic CtxOS Theme Menu for Elephant/Walker
--
Name = "ctxosthemes"
NamePretty = "CtxOS Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/ctxos/themes"
  local ctxos_path = os.getenv("CTXOS_PATH") or ""
  local default_theme_dir = ctxos_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "ctxos-theme-set " .. theme_name,
            },
          })
        end
      end
